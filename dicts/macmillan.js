  if (typeof Macmillan == 'undefined') {

    class Macmillan {
        constructor() {
            this.word = '';
            this.selector = '.SENSE-BODY';
            this.attr = 'innerHTML';
            this.base = 'https://www.macmillandictionary.com/us/dictionary/american/'
    ...
    registerDict('enen-Macmillan', Macmillan);
